      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="group rounded-xl border border-[#1E293B] bg-[#0F172A] p-8 transition-colors hover:border-[#94A3B8]/30">
            <div className="mb-4 flex items-center justify-between">
              ...
              <div className="rounded bg-[#1E293B] px-2 py-1 text-xs font-bold tracking-widest text-[#94A3B8]" style={{ fontFamily: "var(--font-mono)" }}>
                INSURANCE
              </div>
            </div>
            <p className="mb-2 font-sans text-base font-bold text-white">
              Manual Workload Reduction
            </p>
            <p className="text-base font-normal text-[#94A3B8] leading-relaxed">
        ...
        <div className="mt-6 rounded-xl border border-[#1E293B] bg-[#0F172A] p-8 md:p-12">
          <blockquote className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-8 font-sans text-lg font-normal italic text-[#94A3B8] md:text-xl leading-relaxed">
