      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="col-span-2">
            ...
            <p className="max-w-xs text-base text-[#94A3B8] leading-relaxed">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="#services" className="text-base text-[#94A3B8] transition-colors duration-300 hover:text-white">
                  Services
                </Link>
              </li>
              <li>
                <Link href="#approach" className="text-base text-[#94A3B8] transition-colors duration-300 hover:text-white">
                  Approach
                </Link>
              </li>
              <li>
                <Link href="#work" className="text-base text-[#94A3B8] transition-colors duration-300 hover:text-white">
                  Case Studies
                </Link>
              </li>
              <li>
                <Link href="#contact" className="text-base text-[#94A3B8] transition-colors duration-300 hover:text-white">
                  Contact
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 flex flex-col items-center justify-between border-t border-[#1E293B] pt-12 md:mt-24 md:flex-row">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            >
              ...
              <span className="text-sm text-[#94A3B8]" style={{ fontFamily: "var(--font-mono)", letterSpacing: "0.05em" }}>
                Live Lab <span className="text-white">Active</span>
              </span>
            </div>
          </div>
          <div className="mt-6 flex space-x-6 md:mt-0">
            <Link href="#" className="text-sm text-[#94A3B8] transition-colors duration-300 hover:text-white">
              Privacy Policy
            </Link>
            <Link href="#" className="text-sm text-[#94A3B8] transition-colors duration-300 hover:text-white">
              Terms of Service
